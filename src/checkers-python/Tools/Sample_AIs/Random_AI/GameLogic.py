from Tools.Sample_AIs.Random_AI.BoardClasses import *
import sys
sys.path.append("AI_Extensions/")
from Tools.Sample_AIs.Random_AI.AI_Extensions import *
#from StudentAI import StudentAI
from Tools.Sample_AIs.Random_AI.StudentAI import StudentAI
from Tools.Sample_AIs.Random_AI.ManualAI import ManualAI
