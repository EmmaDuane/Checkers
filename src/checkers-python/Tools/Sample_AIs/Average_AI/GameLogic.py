from Tools.Sample_AIs.Average_AI.BoardClasses import *
import sys
sys.path.append("AI_Extensions/")
from Tools.Sample_AIs.Average_AI.AI_Extensions import *
#from StudentAI import StudentAI
from AverageAI import StudentAI
from Tools.Sample_AIs.Average_AI.ManualAI import ManualAI
