from Tools.Sample_AIs.Good_AI.BoardClasses import *
import sys
sys.path.append("AI_Extensions/")
from Tools.Sample_AIs.Good_AI.AI_Extensions import *
#from StudentAI import StudentAI
from GoodAI import StudentAI
from Tools.Sample_AIs.Good_AI.ManualAI import ManualAI
