from Tools.Sample_AIs.Poor_AI.BoardClasses import *
import sys
sys.path.append("AI_Extensions/")
from Tools.Sample_AIs.Poor_AI.AI_Extensions import *
#from StudentAI import StudentAI
from PoorAI import StudentAI
from Tools.Sample_AIs.Poor_AI.ManualAI import ManualAI
